    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            paths, envsteps_this_batch = utils.sample_trajectories(
                env, actor, batchsize, params['ep_len'], render=log_video) # TODO
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          ob_batch, ac_batch = replay_buffer.obs[indices], replay_buffer.acs[indices] # TODO
...
def main():
    ...
    parser.add_argument('--learning_rate', '-lr', type=float, default=2e-3)  # LR for supervised learning
